...
* Test Steps
  ...
  5. Now click on the escape button through keyboard or close button and now click on reload button
...
* Expected result
  ...
  5. When we click on the plot button, a popup box with the result ghraph should be displayed on the screen andwhen we click on the close button the popup box should be closed
  6. When we click on the reload button, the page should get reloaded and entered values should be erased from the screen
