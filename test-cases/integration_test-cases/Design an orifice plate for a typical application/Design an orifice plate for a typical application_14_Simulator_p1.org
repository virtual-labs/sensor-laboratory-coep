...
* Test Steps
  ...
  4. Don't select the β value and select the D value from the dropdown list displayed on the screen and click on the 'configure' button and vice-versa

* Expected result
  1. Simulator page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A new page should be opened with the simulation process
  4. An error message should be displayed on the screen as to select the β value and vice-versa
