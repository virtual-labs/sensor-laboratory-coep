...
* Objective
  - To view the Sample Readings of  “Design an orifice plate for a typical application” experiment
...
* Post conditions
  - Nil
* Test Steps
  1. Click on the Sample Readings link 
  2. It should re-direct to the Sample Readings page
  3. Click on the download link

* Expected result
  1. Sample Readings page should be opened
  2. Content should be present with no distortions and Junk characters
  3. The sample readings should get downloaded
