...
* Test Steps
  ...
  4. Don't select the type of speeed from the dropdown list displayed on the screen and click on the 'level2' button

* Expected result
  1. Simulator page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A new page should be opened with the simulation process
  4. An error message should be displayed on the screen as to complete the statistics
